...
import { loadSearchProduct } from "../../apiRequest";
...
const SearchProduct = () => {
  ...
  async function handleSearch() {
    const { products, totalPages, count } = await loadSearchProduct({ search, currentPage, perPage, sort });
